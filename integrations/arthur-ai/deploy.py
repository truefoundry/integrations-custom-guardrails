"""Deploy the Arthur AI wrapper to TrueFoundry as a Service.
...
for _runtime_only in ("TFY_API_KEY", "WRAPPER_API_KEY", "ARTHUR_API_KEY"):
    os.environ.pop(_runtime_only, None)

SERVICE_NAME = os.environ.get("TFY_SERVICE_NAME", "arthur-guardrails-tfy")
...
ARTHUR_API_KEY_SECRET_FQN = os.environ.get(
    "ARTHUR_API_KEY_SECRET_FQN",
    f"tfy-secret://<workspace>/{SERVICE_NAME}/arthur-api-key",
)
ARTHUR_API_BASE = os.environ.get("ARTHUR_API_BASE", "https://engine.platform.arthur.ai")
...
def build_service() -> Service:
    return Service(
        ...
        env={
            ...
            "ARTHUR_API_KEY": ARTHUR_API_KEY_SECRET_FQN,
            "ARTHUR_API_BASE": ARTHUR_API_BASE,
            "PORT": "8000",
            "LOG_LEVEL": "info",
            "BUILD_REF": BUILD_REF,
        },
...
def _check_placeholders() -> None:
    fields = {
        ...
        "ARTHUR_API_KEY_SECRET_FQN": ARTHUR_API_KEY_SECRET_FQN,
    }
...
if __name__ == "__main__":
    ...
    print(
        ...
        "\nOperation = Validate. Auth = Custom Bearer Auth with WRAPPER_API_KEY."
    )
